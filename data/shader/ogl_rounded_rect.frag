...
void main()
{
	vec4 border_radius = ubo.payload[instance_index].border_radius * 2.;	 
	vec4 color = ubo.payload[instance_index].color; 
	float line_width = ubo.payload[instance_index].line_width.x * 2.;
