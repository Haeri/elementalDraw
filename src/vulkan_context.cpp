...
void Context::stroke_rounded_rect(float x, float y, float width, float height, float tl, float tr,
                                  float br, float bl)
{
}
...
void Context::fill_rounded_rect(float x, float y, float width, float height, float tl,
...
VulkanContext::VulkanContext(Window* window)
{
    ...
    vku::err_check(vkGetPhysicalDeviceSurfaceFormatsKHR(
        physicalDevices[bestDevice.deviceIndex], *_vulkanSurface, &surfaceFormatCount, nullptr));
