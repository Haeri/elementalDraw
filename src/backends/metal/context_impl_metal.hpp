#ifndef ELEMD_METAL_CONTEXT_HPP
#define ELEMD_METAL_CONTEXT_HPP
...
namespace elemd
{
    class ContextImplMetal : public Context
    {
    public:        
        ...
        ImageImplMetal* dummy;
        std::vector<ImageImplMetal*> images;
        ...
        ContextImplMetal(Window* window);
        ~ContextImplMetal();
