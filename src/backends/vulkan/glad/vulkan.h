/**
 * Loader generated by glad 2.0.0-beta on Sat Jan 23 06:23:35 2021
 *
 * Generator: C/C++
 * Specification: vk
 * Extensions: 4
 ...
 * Commandline:
 *    --api='vulkan=1.2'
 * --extensions='VK_AMD_display_native_hdr,VK_EXT_swapchain_colorspace,VK_KHR_surface,VK_KHR_swapchain'
 * c --loader
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.2&extensions=VK_AMD_display_native_hdr%2CVK_EXT_swapchain_colorspace%2CVK_KHR_surface%2CVK_KHR_swapchain&generator=c&options=LOADER
 *
 */
...
#define VK_KHR_swapchain 1
    ...
    typedef VkResult(GLAD_API_PTR* PFN_vkBindBufferMemory)(VkDevice device, VkBuffer buffer,
                                                           VkDeviceMemory memory,
                                                           VkDeviceSize memoryOffset);
    ...
    typedef VkResult(GLAD_API_PTR* PFN_vkBindImageMemory)(VkDevice device, VkImage image,
                                                          VkDeviceMemory memory,
                                                          VkDeviceSize memoryOffset);
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdDispatchIndirect)(VkCommandBuffer commandBuffer,
                                                          VkBuffer buffer, VkDeviceSize offset);
    typedef void(GLAD_API_PTR* PFN_vkCmdDraw)(VkCommandBuffer commandBuffer, uint32_t vertexCount,
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdSetBlendConstants)(VkCommandBuffer commandBuffer,
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdSetDeviceMask)(VkCommandBuffer commandBuffer,
                                                       uint32_t deviceMask);
    ...
    typedef PFN_vkVoidFunction(GLAD_API_PTR* PFN_vkGetDeviceProcAddr)(VkDevice device,
                                                                      const char* pName);
    typedef void(GLAD_API_PTR* PFN_vkGetDeviceQueue)(VkDevice device, uint32_t queueFamilyIndex,
    ...
    typedef PFN_vkVoidFunction(GLAD_API_PTR* PFN_vkGetInstanceProcAddr)(VkInstance instance,
                                                                        const char* pName);
    ...
    typedef VkResult(GLAD_API_PTR* PFN_vkInvalidateMappedMemoryRanges)(
        VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges);
    typedef VkResult(GLAD_API_PTR* PFN_vkMapMemory)(VkDevice device, VkDeviceMemory memory,
    ...
    typedef VkResult(GLAD_API_PTR* PFN_vkQueueSubmit)(VkQueue queue, uint32_t submitCount,
    ...
    typedef VkResult(GLAD_API_PTR* PFN_vkResetFences)(VkDevice device, uint32_t fenceCount,
                                                      const VkFence* pFences);
    typedef void(GLAD_API_PTR* PFN_vkResetQueryPool)(VkDevice device, VkQueryPool queryPool,
                                                     uint32_t firstQuery, uint32_t queryCount);
    typedef VkResult(GLAD_API_PTR* PFN_vkSetEvent)(VkDevice device, VkEvent event);
    typedef void(GLAD_API_PTR* PFN_vkSetLocalDimmingAMD)(VkDevice device, VkSwapchainKHR swapChain,
                                                         VkBool32 localDimmingEnable);
    ...
    typedef VkResult(GLAD_API_PTR* PFN_vkWaitForFences)(VkDevice device, uint32_t fenceCount,
...
#define vkWaitSemaphores glad_vkWaitSemaphores
    ...
    GLAD_API_CALL int gladLoaderLoadVulkan(VkInstance instance, VkPhysicalDevice physical_device,
                                           VkDevice device);
